...
// import 'package:firebase_dynamic_links/firebase_dynamic_links.dart'; // Package discontinued
...
// Stub for SocialMetaTagParameters (from discontinued firebase_dynamic_links)
...
// Stub classes for Firebase Dynamic Links (package discontinued)
...
class FirebaseDynamicLinks {
  static FirebaseDynamicLinks get instance => FirebaseDynamicLinks();

  Stream<PendingDynamicLinkData> onLink = const Stream.empty();

  Future<PendingDynamicLinkData?> getInitialLink() async {
    return null;
  }

  Future<ShortDynamicLink> buildShortLink(DynamicLinkParameters parameters) async {
    // Return a stub link
    return ShortDynamicLink(
      shortUrl: parameters.link,
      previewLink: parameters.link,
    );
  }
}
