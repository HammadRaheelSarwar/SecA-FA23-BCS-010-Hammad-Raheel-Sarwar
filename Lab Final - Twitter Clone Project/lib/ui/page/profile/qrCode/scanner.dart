...
// import 'package:qr_code_scanner/qr_code_scanner.dart'; // Package removed for AGP compatibility
import 'package:qr_flutter/qr_flutter.dart';
import 'dot_indicator.dart';

// Stub types for qr_code_scanner
class Barcode {
  final String code;
  Barcode(this.code);
}
...
class QRViewController {
  void dispose() {}
  final scannedDataStream = const Stream.empty();
  void pauseCamera() {}
  void resumeCamera() {}
}
...
class QrScannerOverlayShape extends Decoration {
  ...
  BoxPainter createBoxPainter([VoidCallback? onChanged]) {
    return _QrScannerOverlayPainter(
...
class _QrScannerOverlayPainter extends BoxPainter {
  final double borderRadius;
  final double borderLength;
  final double borderWidth;
  final double cutOutSize;
  ...
  void paint(Canvas canvas, Offset offset, ImageConfiguration configuration) {
    // Stub implementation - doesn't draw anything
  }
}
